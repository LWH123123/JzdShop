 ...
 * TIP：
 */
public class LocalLifeEntity {
    /**
     * result : {"total":0,"commission_total":0,"data":[]}
     */

    private LocalLifeEntity.ResultBean result;

    public LocalLifeEntity.ResultBean getResult() {
        return result;
    }

    public void setResult(LocalLifeEntity.ResultBean result) {
        this.result = result;
    }
    ...
    public static class ResultBean implements Serializable {
        ...
        private List<LocalLifeEntity.ResultBean.AssetsRecordBean> data;
        ...
        public List<LocalLifeEntity.ResultBean.AssetsRecordBean> getData() {
            return data;
        }

        public void setData(List<LocalLifeEntity.ResultBean.AssetsRecordBean> data) {
            this.data = data;
        }
