...
/**
 * @author LXB
 * @description: recycleView 分隔线
 * tip :可以取消底部分割线的ItemDecoration
 * @date :2019/12/26 12:27
 */
public class CustomDividerItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public CustomDividerItemDecoration(Context context, int orientation, boolean
            isShowBottomDivider) {
