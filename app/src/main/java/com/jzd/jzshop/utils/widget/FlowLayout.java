 ...
 * https://www.jianshu.com/p/1edc6f71ccfd
 * recycler 失效
 * <p>
 * 【Android】自定义流式布局 - 简书
 * https://www.jianshu.com/p/ae8ffdab753d
 */
...
//                modeWidth == MeasureSpec.EXACTLY ? sizeWidth : width + this.getPaddingLeft() + this.getPaddingRight(),
//                modeHeight == MeasureSpec.EXACTLY ? sizeHeight : height + this.getPaddingTop() + this.getPaddingBottom());
