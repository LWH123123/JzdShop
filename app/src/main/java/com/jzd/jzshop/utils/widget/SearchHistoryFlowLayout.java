...
public class SearchHistoryFlowLayout extends ViewGroup {
    ...
    public SearchHistoryFlowLayout(Context context, int lineSpacing, int usefulWidth) {
        this(context, (AttributeSet) null);
        this.lineSpacing = lineSpacing;
        this.usefulWidth = usefulWidth;
    }

    public SearchHistoryFlowLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SearchHistoryFlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
