 ...
 * TIP：
 */
public class AwardInvalidFragment extends BaseFragment<FragmentAwardListPageBinding, AwardAllFragmViewModel> {
    ...
    public Fragment newInstance(List<AwardListEntity.ResultBean.AssetsRecordBean> dataList) {
        AwardInvalidFragment fragment = new AwardInvalidFragment();
