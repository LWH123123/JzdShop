...
/**
 * Created by  lxb on 2020/2/12.
 * 邮箱：2072301410@qq.com
 * TIP：
 */
public class AwardAlreadyPaidFragment extends BaseFragment<FragmentAwardListPageBinding, AwardAllFragmViewModel> {
    ...
    public AwardAlreadyPaidFragment() {
    ...
    public Fragment newInstance(List<AwardListEntity.ResultBean.AssetsRecordBean> dataList) {
        AwardAlreadyPaidFragment fragment = new AwardAlreadyPaidFragment();
    ...
    public void initViewObservable() {
        ...
        viewModel.uc.mLiveData.observe(this, new Observer<AwardListEntity.ResultBean>() {
            ...
            public void onChanged(@Nullable AwardListEntity.ResultBean resultBean) {
                ...
                mAdapter = new AwardListPageFragAdapter(getActivity(),
                           viewModel, dataList, R.layout.item_rv_award_list_fragm_page);
