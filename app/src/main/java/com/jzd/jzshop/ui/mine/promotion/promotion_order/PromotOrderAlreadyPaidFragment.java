 ...
 * TIP：
 */
public class PromotOrderAlreadyPaidFragment extends BaseFragment<FragmentPromotOrderAllBinding, PromotOrderAllFragmViewModel> {
    ...
    public PromotOrderAlreadyPaidFragment() {
    ...
    public Fragment newInstance(List<PromotionOrderEntity.ResultBean.PromoOrderBean> dataList) {
        PromotOrderAlreadyPaidFragment fragment = new PromotOrderAlreadyPaidFragment();
