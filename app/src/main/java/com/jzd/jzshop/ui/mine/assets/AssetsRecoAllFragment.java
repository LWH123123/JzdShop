 ...
 * TIP：
 */
public class AssetsRecoAllFragment extends BaseFragment<FragmentAssetsRecordPageBinding, AssetsRecoAllFragmViewModel>
    ...
    public int initVariableId() {
        return BR.assetsRecordFragmPageVM;
    }
...
//        for (int i = 0; i < 1; i++) {
//            chidList.add(new AssetsRecordEntity.ResultBean.AssetsRecordBean.GoodBean(
//                    23,
//                    "休闲百搭阔腿裤",
...
//        }
//        for (int i = 0; i < 5; i++) {
//            dataList.add(new AssetsRecordEntity.ResultBean.AssetsRecordBean(
//                    "ME202001191356161643161",
//                    "2020-01-12 14:41", 90.00, chidList));
//        }
//
//        mAdapter = new AssetsRecordPageFragAdapter(getActivity(),
//                viewModel, dataList, R.layout.item_rv_assets_record_fragm_page);
//        binding.rv.setAdapter(mAdapter);
//        binding.rv.setLayoutManager(new LinearLayoutManager(getActivity()));
//                View headerView = LayoutInflater.from(getActivity()).inflate(R.layout.item_rv_award_list_header_view, null);
//                initHeaderData(headerView);
//                mAdapter.addHeaderView(headerView);
    ...
    private void initHeaderData(View headerView) {
        ...
        double commission = data.getCommission(); //累计奖励
        String money = MoneyFormatUtils.keepTwoDecimal(commission);
