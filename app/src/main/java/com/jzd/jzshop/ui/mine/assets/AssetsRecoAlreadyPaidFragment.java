 ...
 * TIP：
 */
public class AssetsRecoAlreadyPaidFragment extends BaseFragment<FragmentAssetsRecordPageBinding, AssetsRecoAllFragmViewModel>
    ...
    public AssetsRecoAlreadyPaidFragment() {
