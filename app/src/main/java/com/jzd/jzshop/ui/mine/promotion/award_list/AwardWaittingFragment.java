 ...
 * TIP：
 */
public class AwardWaittingFragment extends BaseFragment<FragmentAwardListPageBinding, AwardAllFragmViewModel> {
    ...
    public Fragment newInstance(List<AwardListEntity.ResultBean.AssetsRecordBean> dataList) {
        AwardWaittingFragment fragment = new AwardWaittingFragment();
