 ...
 */
public class InCommisWithdrawViewModel extends ToolbarViewModel<Repository> {

    private static final String TAG = InCommisWithdrawViewModel.class.getSimpleName();
    private Context context;
    private FragmentInCommisWithdrawBinding mBinding;
    //分页加载字段-------------
    ...
    public InCommisWithdrawViewModel(@NonNull Application application, Repository model) {
        super(application, model);
    }

    public void setBinding(Context mContext, FragmentInCommisWithdrawBinding binding) {
