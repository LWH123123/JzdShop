 ...
 * @date :2020/4/7 10:29
 */
public class ContinuousSignInFragment extends BaseFragment<FragmentContinuousSignInBinding, ContinuousSignInViewModel>
        implements OnRefreshListener, OnLoadmoreListener {
    private String type = "continue";
    ...
    public ContinuousSignInFragment() {
