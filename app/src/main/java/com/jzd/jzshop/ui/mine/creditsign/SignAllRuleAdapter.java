 ...
 */
public class SignAllRuleAdapter extends SuperAdapter<SignEntity.ResultBean.AllRuleBean> {
    private Context mContext;
    public CreditSignNewViewModel mViewModel;
    public SignAllRuleAdapter(Context context, List<SignEntity.ResultBean.AllRuleBean> items, int layoutResId, CreditSignNewViewModel viewModel) {
    ...
    @Override
    public void onBind(SuperViewHolder holder, int viewType, int layoutPosition, final SignEntity.ResultBean.AllRuleBean item) {
        ...
        if (signed == 1){
            ...
            holder.setOnClickListener(R.id.tv_receive, new View.OnClickListener() { //领取
                ...
                public void onClick(View v) {
                    mViewModel.postToReceive("2",String.valueOf(item.getDay()));
                }
            });
