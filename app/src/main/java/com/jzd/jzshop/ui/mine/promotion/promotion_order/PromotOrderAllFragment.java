 ...
 * TIP： 推广佣金 推广
 */
public class PromotOrderAllFragment extends BaseFragment<FragmentPromotOrderAllBinding, PromotOrderAllFragmViewModel> {
    ...
    public Fragment newInstance(List<PromotionOrderEntity.ResultBean.PromoOrderBean> dataList) {
        PromotOrderAllFragment fragment = new PromotOrderAllFragment();
