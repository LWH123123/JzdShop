 ...
 * TIP：
 */
public class AwardRecoPaidFragment extends BaseFragment<FragmentAwardListPageBinding, AwardAllFragmViewModel> {
    ...
    public Fragment newInstance(List<AwardListEntity.ResultBean.AssetsRecordBean> dataList) {
        AwardRecoPaidFragment fragment = new AwardRecoPaidFragment();
    ...
    public void initViewObservable() {
        ...
        viewModel.uc.mLiveData.observe(this, new Observer<AwardListEntity.ResultBean>() {
            ...
            public void onChanged(@Nullable AwardListEntity.ResultBean resultBean) {
                ...
                mAdapter = new AwardListPageFragAdapter(getActivity(), viewModel, dataList, R.layout.item_rv_award_list_fragm_page);
