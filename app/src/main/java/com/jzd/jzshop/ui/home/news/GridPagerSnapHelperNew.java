 ...
 */
@Deprecated
public class GridPagerSnapHelperNew extends SnapHelper {
    @Nullable
     ...
     * @param column 列
     */
    public GridPagerSnapHelperNew(int row, int column) {
        this.rowCount = row;
    ...
    protected LinearSmoothScroller createSnapScroller(LayoutManager layoutManager) {
        return !(layoutManager instanceof ScrollVectorProvider) ? null : new LinearSmoothScroller(this.recyclerView.getContext()) {
            protected void onTargetFound(View targetView, State state, Action action) {
                int[] snapDistances = GridPagerSnapHelperNew.this.calculateDistanceToFinalSnap(GridPagerSnapHelperNew.this.recyclerView.getLayoutManager(), targetView);
