 ...
 * TIP： 充值记录
 */
public class RechargeRecordAty extends BaseActivity<ActivityRechargeRecordBinding, RechargeRecordViewModel> implements
    ...
    public void initData() {
        ...
        getIntentData();
        viewModel.initToolBar(getResources().getString(R.string.recharge_record));
    ...
    public void initViewObservable() {
        ...
        viewModel.uc.mLiveData.observe(this, new Observer<List<RechargeRecordEntity.ResultBean>>() {
            @Override
            public void onChanged(@Nullable List<RechargeRecordEntity.ResultBean> result) {
                ...
                if (adapter == null) {
                    adapter = new RechargeRecordAdapter(mContext,
                            result, R.layout.item_rv_recharge_record);
