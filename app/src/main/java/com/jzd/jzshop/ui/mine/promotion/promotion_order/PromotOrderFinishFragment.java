 ...
 * TIP：
 */
public class PromotOrderFinishFragment extends BaseFragment<FragmentPromotOrderAllBinding, PromotOrderAllFragmViewModel> {
    ...
    public PromotOrderFinishFragment() {
    ...
    public Fragment newInstance(List<PromotionOrderEntity.ResultBean.PromoOrderBean> dataList) {
        PromotOrderFinishFragment fragment = new PromotOrderFinishFragment();
