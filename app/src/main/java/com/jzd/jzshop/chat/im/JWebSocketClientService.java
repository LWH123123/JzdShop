...
//            startForeground(GRAY_SERVICE_ID, new Notification());
            //兼容 Android  8.0 ，8.1 + 的service 正常开启
            NotificationManager notificationManager = (NotificationManager) getApplication().getSystemService(Context.NOTIFICATION_SERVICE);
            NotificationChannel mChannel = null;
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
                mChannel = new NotificationChannel(CHANNEL_ID_STRING, "chat", NotificationManager.IMPORTANCE_HIGH);
    ...
    public void initSocketClient() {
        URI uri = URI.create(RetrofitClient.ws);
...
//    -----------------------------------消息通知--------------------------------------------------------
    ...
    private void sendNotification(String content) {
        Intent intent = new Intent();
        intent.setClass(this, OpenChatActivity.class);
