...
import com.jzd.jzshop.app.Injection;
...
public class WXEntryActivity extends AuthActivity implements IWXAPIEventHandler {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // 微信事件回调接口注册
        AppApplication.sApi.handleIntent(getIntent(), this);
        mGson = new Gson();
    }
...
//        final String refreshToken = (String) ShareUtils.getValue(this, WEIXIN_REFRESH_TOKEN_KEY, "");
        ...
        httpRequest(url, new ApiCallback<String>() {
            ...
            public void onError(int errorCode, final String errorMsg) {
                ...
                // 重新请求授权
                loginWeixin(WXEntryActivity.this.getApplicationContext(), AppApplication.sApi);
            }
...
//用 WXWebpageObject 对象初始化一个 WXMediaMessage 对象
        ...
        //调用api接口，发送数据到微信
        AppApplication.sApi.sendReq(req);
    }
