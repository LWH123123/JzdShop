...
<layout>
    <data>
        <variable
            type="com.jzd.jzshop.ui.demo.login.LoginViewModel"
            name="viewModel"
        />
    </data>
    .....
...
```
> R文件需要在data标签中导入使用，如：`<import type="com.jzd.jzshop.R" />`

要圆角图片可以这样设置
binding:isRounded="@{true}"
要圆形图片这样设置
...
## ================= LXB add======================start====================
//MVVMHabit 使用 需gradle plugin版本 3.5.0以下版本，以上版本会造成gradle编译错误！！切记切记
## 框架使用 常见报错解决参考链接： https://www.cnblogs.com/Android-Alvin/p/12659390.html
一、编译错误解决方法
     4.1.1、绑定错误
     4.1.2、xml导包错误
     4.1.3、build错误
