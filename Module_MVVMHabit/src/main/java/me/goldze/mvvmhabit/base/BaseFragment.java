...
public abstract class BaseFragment<V extends ViewDataBinding, VM extends BaseViewModel> extends RxFragment implements IBaseView {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        initParam();
        getActivity().getWindow().getDecorView().setBackground(new ColorDrawable(getResources().getColor(R.color.white)));
    }
    ...
    protected void initStatusBar() {
        ...
        StatusBarUtil.setTranslucentStatus(getActivity());      //设置状态栏透明
